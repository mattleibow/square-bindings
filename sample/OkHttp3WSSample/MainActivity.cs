...
{
    [Activity(Label = "OkHttp3WSSample", MainLauncher = true, Icon = "@drawable/icon", Theme = "@style/Theme.AppCompat")]
    public class MainActivity : AppCompatActivity
    {
        ...
        protected override void OnCreate(Bundle bundle)
        {
            ...
            startTest.Click += delegate
            {
                ...
                {
                    string payload = e.Message.String();
                    e.Message.Close();
                    RunOnUiThread(() => adapter.Add(string.Format("{0}\n{1}", payload, e.Message.ContentType())));
                };
